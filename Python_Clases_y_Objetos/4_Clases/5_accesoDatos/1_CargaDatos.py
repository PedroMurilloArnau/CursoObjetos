...
datos.to_csv('F:\DAW\datos\precios_coches_nuevo.csv')

datos.to_json('F:\DAW\datos\precios_coches_nuevo.json')

datos.to_excel('F:\DAW\datos\precios_coches_nuevo.xlsx')

df_xcel = pd.read_excel('F:\DAW\datos\precios_coches_nuevo.xlsx')
df_json = pd.read_json('F:\DAW\datos\precios_coches_nuevo.json')
